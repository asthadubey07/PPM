    ...
    public class ProjectEmployeeUi
    {
        ...
        public void AddEmployeeToProject()
        {
            ...
            else
            {
                ...
                Console.WriteLine("Failed to add employee to the project. Check the provided IDs and project's employee list.");
                Console.ResetColor();
        ...
        public void ViewProjectEmployeesByRole()
        {
            ...
            if (employeesByRole != null)
            {
                foreach (var role in employeesByRole)
                {
                    ...
                    {
                        Console.ForegroundColor = ConsoleColor.DarkYellow;
                        Console.WriteLine($"Employee ID: {employee.Id}, FirstName: {employee.FristName} LastName:{employee.LastName}");
                        Console.ResetColor();
                    }
                }
            }
